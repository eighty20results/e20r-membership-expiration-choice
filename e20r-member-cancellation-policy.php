...
class E20R_Member_Cancellation {
	...
	/**
	 * E20R_Membership_Expiration_Choice constructor.
	 */
	...
	public static function register() {
		...
		if ( 'end_of_period' === $plugin->get_setting( 'termination-choice' ) &&
			...
			add_action( 'pmpro_before_change_membership_level', array( $plugin, 'before_change_membership_level' ), 10, 2 );
		}
		...
		<div class="e20r-member-cancellation-policy-settings">
			<div class="e20r-settings-body">
				<div class="e20r-settings-row">
					...
					<div class="e20r-settings-cell">
						<select name="e20r-cancellation-policy_termination-choice" class="e20r-cancellation-policy_termination-choice" id="e20r-cancellation-policy_termination-choice">
							<option
