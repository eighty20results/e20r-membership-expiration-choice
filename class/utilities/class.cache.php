...
if ( ! defined( 'ABSPATH' ) ) {
	wp_die( __( "Cannot access file directly", 'e20r-member-cancellation-policy' ) );
}

if ( ! class_exists( 'E20R\Member_Cancellation\Utilities\Cache' ) ) {
