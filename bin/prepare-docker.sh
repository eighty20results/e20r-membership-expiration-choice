...
PROJECT_NAME='e20r-member-cancellation-policy' ; export PROJECT_NAME
...
then
    ...
    ssh docker.local "cd ./www/docker-images/docker4wordpress/ ; make wp plugin activate e20r-member-cancellation-policy"
    ...
    cp ${PLUGIN_DIR}/docker-compose.override.yml ~/PhpStormProjects/docker-images/docker4wordpress/docker-compose.override.yml
    ...
    nohup ./import-db.sh
    # ./import-db.sh
   make wp plugin activate e20r-member-cancellation-policy
